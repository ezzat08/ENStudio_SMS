...
<div class="container">
	<div class="row">
		...
		<div class="col-md-6">
			...
			elseif ($tempcourse == '2'){
				$sql = "UPDATE `studenttable2` SET FName='$tempfname', LName='$templname', FaName='$tempfaname', Gender='$tempgender', Course='$tempcourse', Addrs='$tempaddrs', PhNo=$tempphno, Eid='$tempeid', Pass='$temppass'  WHERE Eno=$new3";
			...
			elseif ($tempcourse == '3'){
				$sql = "UPDATE `studenttable3` SET FName='$tempfname', LName='$templname', FaName='$tempfaname', Gender='$tempgender', Course='$tempcourse', Addrs='$tempaddrs', PhNo=$tempphno, Eid='$tempeid', Pass='$temppass'  WHERE Eno=$new3";
