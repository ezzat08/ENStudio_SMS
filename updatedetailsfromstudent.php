	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<form action="" method="POST" name="update">
				...
				<br>
				<div class="form-group">
					<a href="mydetailsstudent"><input type="button" value="Back" class="btn btn-success" style="border-radius:0%"></a>
			...
			if ( isset( $_POST[ 'update' ] ) ) {
				...
				$sql = "UPDATE `studenttable` SET FName='$tempfname', LName='$templname', FaName='$tempfaname', Gender='$tempgender', Course='$tempcourse', Addrs='$tempaddrs', PhNo=$tempphno, Eid='$tempeid'  WHERE Eno=$new3";
