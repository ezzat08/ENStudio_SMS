	...
	<div class="row">
		<div class="col-md-12">
			...
			while ( $row = mysqli_fetch_array( $rs ) ) {
				?>
			<fieldset>
				<legend><a href="manageassessment.php" >Edit Quiz</a></legend>
				<form action="" method="POST" name="UpdateAssessment">
					<table class="table table-hover">

						<tr>
							<td><strong>Quiz ID</strong>
							</td>
							<td>
			...
			$make = $_GET[ 'editassid' ];
			//selecting data form assessment details table form database
			$sql = "SELECT * FROM examdetails2 WHERE ExamID=$make";
			$rs = mysqli_query( $connect, $sql );
			while ( $row = mysqli_fetch_array( $rs ) ) {
				?>
			<fieldset>
				...
				<form action="" method="POST" name="UpdateAssessment">
					<table class="table table-hover">
						...
						<?php 
							...
							$sql = "UPDATE `examdetails2` SET ExamName='$E_name' , Q1='$Q_1' , Q2='$Q_2' , Q3='$Q_3', Q4='$Q_4', Q5='$Q_5' WHERE ExamID=$make";
			...
			$make = $_GET[ 'editassid' ];
			//selecting data form assessment details table form database
			$sql = "SELECT * FROM examdetails3 WHERE ExamID=$make";
			$rs = mysqli_query( $connect, $sql );
			while ( $row = mysqli_fetch_array( $rs ) ) {
				?>
			<fieldset>
				...
				<form action="" method="POST" name="UpdateAssessment">
					<table class="table table-hover">
						...
						<?php 
							...
							$sql = "UPDATE `examdetails3` SET ExamName='$E_name' , Q1='$Q_1' , Q2='$Q_2' , Q3='$Q_3', Q4='$Q_4', Q5='$Q_5' WHERE ExamID=$make";
