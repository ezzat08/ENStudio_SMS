	...
	<div class="row">
		<div class="col-md-12">
			...
			<tr>
				...
				<td><a href="updatequery.php?gid=<?php echo $row['Qid']; ?>"><input type="button" Value="Edit" class="btn btn-success btn-sm" style="border-radius:0%"></a>
				<a href="qureydetails.php?deleteid=<?php echo $row['Qid']; ?>"><input type="button" Value="Delete" name="" class="btn btn-danger btn-sm" style="border-radius:0%"></a>
				</td>
			</tr>
			<?php $count++; } ?>
			</table>
