	...
	<div class="container">
     <div class="row">
			...
			<div class="col-md-6">
				...
				Tutor ID : <?php echo $row['FID']; ?></div>
				<div class="form-group">
				Tutor Name : <input type="text" name="fname" class="form-control" value="<?php echo $row['FName']; ?>"></div>
				<div class="form-group">
				...
				<div class="form-group">
				Password : <input type="text" name="pass" class="form-control" value="<?PHP echo $row['Pass'];?>" maxlength="12"><br></div><br>
				<div class="form-group">
					<a href="facultydetails"><input type="button" value="Back" class="btn btn-success" style="border-radius:0%"></a>
