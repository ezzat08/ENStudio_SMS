	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<form action="" method="POST" name="update">
				...
				<div class="form-group">
					Form : <input type="text" name="course" class="form-control" value="<?PHP echo $row['Course'];?>"><br>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<a href="studentdetails.php"><input type="button" value="Back" href="studentdetails"class="btn btn-success" style="border-radius:0%"></a>
			...
			$new3 = $_GET[ 'eno' ];
			//below query will print the existing record of student
			$sql = "SELECT * from  studenttable2 where Eno=$new3";
			$result = mysqli_query( $connect, $sql );
			...
			$new3 = $_GET[ 'eno' ];
			//below query will print the existing record of student
			$sql = "SELECT * from  studenttable3 where Eno=$new3";
			$result = mysqli_query( $connect, $sql );
			...
			if ( isset( $_POST[ 'update' ] ) ) {
				...
				if ($tempcourse == '1'){
				$sql = "UPDATE `studenttable` SET FName='$tempfname', LName='$templname', FaName='$tempfaname', Gender='$tempgender', Course='1', Addrs='$tempaddrs', PhNo=$tempphno, Eid='$tempeid', Pass='$temppass'  WHERE Eno=$new3";
			...
			elseif ($tempcourse == '2'){
				$sql = "UPDATE `studenttable2` SET FName='$tempfname', LName='$templname', FaName='$tempfaname', Gender='$tempgender', Course='2', Addrs='$tempaddrs', PhNo=$tempphno, Eid='$tempeid', Pass='$temppass'  WHERE Eno=$new3";
			...
			elseif ($tempcourse == '3'){
				$sql = "UPDATE `studenttable3` SET FName='$tempfname', LName='$templname', FaName='$tempfaname', Gender='$tempgender', Course='3', Addrs='$tempaddrs', PhNo=$tempphno, Eid='$tempeid', Pass='$temppass'  WHERE Eno=$new3";
