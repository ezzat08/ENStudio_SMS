...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4">
			...
			<h4 class="page-header">Add New Tutor </h4>
			<?php
			...
			<form action="" method="POST" name="update">
				...
				<div class="form-group">
					<label for="Faculty Name">Tutor Name : <span style="color: #ff0000;">*</span></label>
				...
				<div class="form-group">
					<a href="facultydetails"><input type="button" value="Back" href="facultydetails"class="btn btn-success" style="border-radius:0%"></a>
					<input type="submit" value="Add New Tutor" name="addnewtutor" style="border-radius:0%" class="btn btn-success">
				</div>
