...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			...
			$sql = "select * from  studenttable2 where Eno='$sEno'";
			$sql2 = "select * from  examdetails2 where ExamID='$exid'";
			...
			<fieldset>
				...
				?>
					...
					?>
						...
						<a href="takeassessment"><input type="button" value="Back" class="btn btn-success" style="border-radius:0%"></a>
