...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<a href="addnewfaculty"><button type="button" value="Add New Faculty" class="btn btn-success btn-sm" style="border-radius:0%">Add New Tutor</button></a>
			<?php
			include( "database.php" );
			$sql = "SELECT * from  facutlytable";
			$result = mysqli_query( $connect, $sql );
			echo "<h3 class='page-header' >Tutor Details</h3>";
