...
<div class="form-wrapper">
  <fieldset>
				<legend>
					<h3 style="padding-top: 25px;"><span class="glyphicon glyphicon-lock" style="color:#000000"></span>&nbsp;Student Login</h3>
				</legend>
				<!-- Admin login form -->
				<form name="studentlogin" action="loginstudent" method="POST">
